// DotNetInfoCommand.h : Declaration of the CDotNetInfoCommand
...
class ATL_NO_VTABLE CDotNetInfoCommand :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CDotNetInfoCommand, &CLSID_DotNetInfoCommand>,
	public ICommand2,
...
public:
	...
	BEGIN_COM_MAP(CDotNetInfoCommand)
...
public:
	...
	STDMETHOD(GetCommandText)(REFGUID guidId, BSTR* bstrText)
	{
		...
		*bstrText = CComBSTR(L"CLR Info").Copy();
		return S_OK;
	}
	...
	STDMETHOD(Invoke)(REFGUID guidId)
	{
		...
		RETURN_IF_FAILED(pDebugFormManager->OpenForm(DBGCOMMAND_DOTNETINFO, NULL));
		return S_OK;
	}
	...
	STDMETHOD(InstallMenu)(IMenu* pMenu)
	{
		...
		return pMenu->AddMenuCommand(COMMAND_COMMANDS, COMMAND_DOTNETINFO, this);
	}
...
OBJECT_ENTRY_AUTO(__uuidof(DotNetInfoCommand), CDotNetInfoCommand)
