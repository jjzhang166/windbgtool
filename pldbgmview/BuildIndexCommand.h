...
// BuildIndexCommand.h : Declaration of the CBuildIndexCommand
...
class ATL_NO_VTABLE CBuildIndexCommand :
    public CComObjectRootEx<CComSingleThreadModel>,
    public CComCoClass<CBuildIndexCommand, &CLSID_BuildIndexCommand>,
    public ICommand2,
...
public:
    ...
    BEGIN_COM_MAP(CBuildIndexCommand)
...
public:
    ...
    STDMETHOD(GetCommandText)(REFGUID guidId, BSTR* bstrText)
    {
        ...
        *bstrText = CComBSTR(L"Build index").Copy();
        return S_OK;
    }
    ...
    STDMETHOD(Invoke)(REFGUID guidId)
    {
        ...
        RETURN_IF_FAILED(pDebugFormManager->OpenForm(DBGCOMMAND_BUILD_INDEX, NULL));
        return S_OK;
    }
    ...
    STDMETHOD(InstallMenu)(IMenu* pMenu)
    {
        ...
        return pMenu->AddMenuCommand(COMMAND_COMMANDS, COMMAND_BUILD_INDEX, this);
    }
...
OBJECT_ENTRY_AUTO(__uuidof(BuildIndexCommand), CBuildIndexCommand)
